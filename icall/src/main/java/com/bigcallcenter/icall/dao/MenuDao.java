...
public class MenuDao extends BaseDao {
	...
	public List<MenuInfo> getMenuInfoByUser(String loginName){
		...
		sql.append(" where d.login_name = ?");
		return null;
//		return this.getJdbcTemplate().queryForList(sql.toString(),new Object[]{loginName,loginName},new BeanPropertyRowMapper<MenuIfo>(MenuInfo.class));
	}
}
